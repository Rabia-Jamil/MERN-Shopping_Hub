                                    ...
                                    <div>
                                        <div className="bookshelf">
                                            ...
                                            <div className="bookshelf-books">
                                                ...
                                                <h6 className="pull-right">See all</h6>
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">On Sale</h4>
                                            <div className="bookshelf-books">
                                                <i class="fa fa-arrow-right pull-right" />
                                                <h6 className="pull-right">See all</h6>
                                                <ol className="books-grid">
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">Categories</h4>
                                            <div className="bookshelf-books">
                                                <ol className="books-grid">
                                                    <li>
                                                        <div className="book">
                                                            <div className="book-top">
                                                                <div className="book-cover" style={{ width: 128, height: 150, backgroundImage: 'url("http://books.google.com/books/content?id=uu1mC6zWNTwC&printsec=frontcover&img=1&zoom=1&imgtk=AFLRE73pGHfBNSsJG9Y8kRBpmLUft9O4BfItHioHolWNKOdLavw-SLcXADy3CPAfJ0_qMb18RmCa7Ds1cTdpM3dxAGJs8zfCfm8c6ggBIjzKT7XR5FIB53HHOhnsT7a0Cc-PpneWq9zX&source=gbs_api")' }}></div>
                                                            </div>
                                                            <div className="book-title text-center">1776</div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="book">
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">Seller Wise</h4>
                                            <div className="bookshelf-books">
                                                <i class="fa fa-arrow-right pull-right" />
                                                <h6 className="pull-right">See all</h6>
                                                <ol className="books-grid">
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">Most Purchased last in 30 days</h4>
                                            <div className="bookshelf-books">
                                                <i class="fa fa-arrow-right pull-right" />
                                                <h6 className="pull-right">See all</h6>
                                                <ol className="books-grid">
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">Most Viewed</h4>
                                            <div className="bookshelf-books">
                                                <i class="fa fa-arrow-right pull-right" />
                                                <h6 className="pull-right">See all</h6>
                                                <ol className="books-grid">
                                        ...
                                        <div className="bookshelf">
                                            <h4 className="bookshelf-title">Recent Searched</h4>
                                            <div className="bookshelf-books">
                                                <i class="fa fa-arrow-right pull-right" />
                                                <h6 className="pull-right">See all</h6>
                                                <ol className="books-grid">
